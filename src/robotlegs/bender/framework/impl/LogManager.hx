 ...
 */class LogManager implements ILogTarget {
	...
	/*============================================================================*/	/* Public Properties                                                          */	/*============================================================================*/	var _logLevel : Int;
	...
	/*============================================================================*/	/* Private Properties                                                         */	/*============================================================================*/	var _targets : Array<ILogTarget>;
	/*============================================================================*/	/* Public Functions                                                           */	/*============================================================================*/	/**
	 ...
	 */	public function log(source : Dynamic, level : Int, timestamp : Int, message : String, params : Array<Dynamic> = null) : Void {
		if(level > _logLevel) 
			return;
		for(target in _targets/* AS3HX WARNING could not determine type for var: target exp: EIdent(_targets) type: Array<ILogTarget>*/) {
