...
class ViewProcessorMapExtension implements IExtension {
	...
	/*============================================================================*/	/* Private Functions                                                          */	/*============================================================================*/	function beforeInitializing() : Void {
		...
		if(_injector.satisfiesDirectly(IViewManager))  {
			...
			_viewManager.addViewHandler(try cast(_viewProcessorMap, IViewHandler) catch(e:Dynamic) null);
		}
	}
	...
	function beforeDestroying() : Void {
		...
		if(_injector.satisfiesDirectly(IViewManager))  {
			_viewManager = _injector.getInstance(IViewManager);
			_viewManager.removeViewHandler(try cast(_viewProcessorMap, IViewHandler) catch(e:Dynamic) null);
		}
	}
