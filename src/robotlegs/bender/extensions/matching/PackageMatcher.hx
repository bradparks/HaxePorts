...
class PackageMatcher implements ITypeMatcher {
	...
	function pushAddedPackagesTo(packages : Array<Dynamic>, targetSet : Array<String>) : Void {
	...
	function pushValuesToStringVector(values : Array<Dynamic>, vector : Array<String>) : Void {
	...
	public function new() {
		_anyOfPackages = new Array<String>();
		_noneOfPackages = new Array<String>();
	}
}
