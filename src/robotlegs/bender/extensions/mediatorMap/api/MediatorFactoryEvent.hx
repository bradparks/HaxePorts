...
class MediatorFactoryEvent extends Event {
    ...
    /*============================================================================*/	
    static public inline var MEDIATOR_CREATE : String = "mediatorCreate";
	static public inline var MEDIATOR_REMOVE : String = "mediatorRemove";
	/*============================================================================*/	
    /* Public Properties                                                          */	
    /*============================================================================*/	
    var _mediator : Dynamic;
    ...
    /* Constructor                                                                */	
    /*============================================================================*/	
    public function new(type : String, mediator : Dynamic, view : Dynamic, mapping : IMediatorMapping, factory : IMediatorFactory) {
		//nme.Lib.trace(this + "::" + type + "::" + mediator + "::" + view + "::" + mapping + "::" + factory);
        super(type);
		_mediator = mediator;
		_view = view;
		_mapping = mapping;
